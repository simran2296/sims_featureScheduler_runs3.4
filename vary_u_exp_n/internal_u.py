...
def example_scheduler(args):
    ...
    # Scale the number of u_band exposures:
    footprints_hp_array['u'] = footprints_hp_array['u']*u_n_scale
...
def sched_argparser():
    ...
    parser.add_argument('--u_exptime', type=float, default=30.)
    parser.add_argument('--u_n_scale', type=float, default=1.)
