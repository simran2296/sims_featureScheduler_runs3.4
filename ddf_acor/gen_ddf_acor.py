...
if __name__ == "__main__":
    ...
    print("python ddf_presched.py --ddf_season_frac 0.2 --low_season_fraction 0 --low_season_rate 0")
        ...
        for low_seaons_fraction in low_seaons_fractions:
            if low_seaons_fraction > ddf_season:
                for low_season_rate in low_season_rates:
                    print("python ddf_presched.py --ddf_season_frac %.2f --low_season_fraction %.2f --low_season_rate %.2f" % (ddf_season, low_seaons_fraction, low_season_rate))
