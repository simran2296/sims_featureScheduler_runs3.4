...
def standard_bf(
    ...
    sa = EuclidOverlapFootprint(nside=nside, smc_radius=4, lmc_radius=6)
            ...
            bfs.append(
                (
                    bf.NObsPerYearBasisFunction(
                        filtername=filtername,
                        nside=nside,
                        footprint=footprints.get_footprint(filtername)*scp_mask,
            ...
            bfs.append(
                (
                    bf.NObsPerYearBasisFunction(
                        filtername=filtername2,
                        nside=nside,
                        footprint=footprints.get_footprint(filtername2)*scp_mask,
