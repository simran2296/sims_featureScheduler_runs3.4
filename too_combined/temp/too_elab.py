...
def set_run_info(dbroot=None, file_end="v3.4_", out_dir=".", scale=None):
...
def example_scheduler(args):
    ...
    sim_ToOs, event_table = gen_all_events(scale=too_scale, nside=nside)#generate_events(
...
def sched_argparser():
    ...
    parser.add_argument("--too_scale", type=float, default=10, help="N events per year")
