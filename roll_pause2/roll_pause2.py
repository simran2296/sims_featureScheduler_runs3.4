...
def make_rolling_footprints(
    ...
    insert_const : int
        When to insert a constant season. Should probably be even to work properly (2, 4, 6).
    ...
    if insert_const2 is not None:
        rolling1.insert(insert_const2, 1)
        rolling2.insert(insert_const2, 1)
