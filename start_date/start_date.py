...
def set_run_info(dbroot=None, file_end="v3.4_", out_dir=".", day_off=0):
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + "_"
    fileroot = os.path.join(out_dir, fileroot + 'do%i' % day_off + file_end)
